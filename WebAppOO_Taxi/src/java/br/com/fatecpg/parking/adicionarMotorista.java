...
public class AdicionarMotorista {
    ...
    public AdicionarMotorista(long id_motorista, String nm_motorista, String nr_cpf, String tp_sexo, String mdl_carro, String email_motorista, long passwordHash) {
    ...
    public static void addDriver(String nm_motorista, String nr_cpf, String tp_sexo, String mdl_carro, String email_motorista, long passwordHash) throws Exception {
        String SQL = "INSERT INTO TB_MOTORISTA VALUES("
                ...
                + ", ?"
                + ")";
        Object parameters[] = {nm_motorista, nr_cpf, tp_sexo, mdl_carro, email_motorista, passwordHash};
    ...
    public static AdicionarMotorista getDriver(String email_motorista, String passwordHash) throws Exception {
        String SQL = "SELECT * FROM TB_MOTORISTA WHERE email_motorista = ? AND passwordHash = ?";
        Object parameters[] = {email_motorista, passwordHash.hashCode()};
